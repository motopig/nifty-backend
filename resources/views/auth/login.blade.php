...
<head>
    ...
    <link href={{ asset("css/login/nifty-icons.min.css")}} rel="stylesheet">

    <link href={{ asset("css/login/nifty.min.css")}} rel="stylesheet">
            ...
            <div class="panel-body">
                ...
                <form role="form" method="POST" action="{{ route('login') }}">
                    ...
                    <div class="checkbox pad-btm text-left">
                        ...
                        <label for="demo-form-checkbox" name="remember" {{ old('remember') ? 'checked' : '' }}>Remember me</label>
                    </div>
